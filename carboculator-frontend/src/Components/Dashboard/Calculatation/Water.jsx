...
const Water = () => {
  return (
    <Box sx={{width:"100%",maxWidth:'66.25rem',minHeight: "31.8rem",border:'2px solid grey',ml:"5rem",mr:"2.5rem",display:"flex",alignItems:"center",justifyContent:"space-around"}}>
      ...
      <Box sx={{width:"12.5rem",height:"3.44rem",backgroundColor:'#446891',borderRadius:"6px",color:'white',display:"flex",justifyContent:'center',alignItems:'center'}}>Source Of Water</Box> 
      ...
      <Box sx={{display:'flex',gap:"2rem"}}> 
      <Box sx={{width:"12.5rem",height:"3.44rem",backgroundColor:'#446891',borderRadius:"6px",color:'white',display:"flex",justifyContent:'center',alignItems:'center'}}>Water Extraction</Box> 
      ...
      <Box sx={{width:"30%",height:'70%',display:'flex',flexDirection:'column',gap:"3rem"}}>
         ...
         <Typography variant='body2' sx={{fontSize:"1rem"}}>The amount of water consumed in litres during the mining process should be noted and calculated to find the Carbon Footprint of the mine</Typography>
